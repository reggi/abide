...
const ERR_STDERR_CLOSE = 'ERR_STDERR_CLOSE'
const ERR_STDOUT_CLOSE = 'ERR_STDOUT_CLOSE'
const ERR_UNKNOWN_STDIN_TYPE = 'ERR_UNKNOWN_STDIN_TYPE'
const ERR_UNKNOWN_STREAM_TYPE = 'ERR_UNKNOWN_STREAM_TYPE'
...
function setupStdio() {
  ...
  Object.defineProperty(value, 'stderr', {
    configurable: true,
    enumerable: true,
    get: getStderr
  });

  Object.defineProperty(value, 'stdin', {
    configurable: true,
    enumerable: true,
    get: getStdin
  });

  value.openStdin = function() {
    value.stdin.resume();
    return value.stdin;
  };
